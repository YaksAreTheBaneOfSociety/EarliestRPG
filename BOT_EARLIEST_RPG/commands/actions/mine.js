...
module.exports = {
	...
	async execute(interaction, client) {
        ...
        function addItemToInventory(item, interaction){
            if(typeof item.value === 'number'){
                ...
                if(item.name in playerSave.inventory[item.type]){
                    playerSave.inventory[item.type][item.name]+= 1+Math.floor(Math.random()*item.value)
                }else{
                    playerSave.inventory[item.type][item.name] = 1+Math.floor(Math.random()*item.value)
                }
            }else{
        ...
        const enemiesList =[
            {name: "Cave Goblin", health: 5, weapons: [{name: "Goblin Spear", damage: "1d2"}, {name: "Goblin Sword", damage: 2}], xp: 10, coins: 10, drops: [{name: "tiny health potion", type: "consumables", value: 1, chance: 0.5},{name: "small health potion", type: "consumables", value: 1, chance: 0.2},{name: "Goblin's Spear", type: "combat", value: {damage:"1d2",price:10}, chance:0.1},{name: "Goblin's Sword", type: "combat", value: {price: 10, damage:2}, chance:0.08}], points : 1, levels: [1, 10]},
            {name: "Rock Beetle", health: 7, weapons: [{name: "Mandibles", damage: "1d3"}], xp: 20, coins: 20, drops: [{name: "stone", type: "ore", value: 1, chance: 0.1},{name: "tiny health potion", type: "consumables", value: 1, chance: 0.2}], points : 2, levels: [1, 20]},
            {name: "Mine Spider", health: 6, weapons: [{name: "Venomous Bite", damage: "1d4"}], xp: 20, coins: 20, drops: [{name: "tiny health potion", type: "consumables", value: 1, chance: 0.2}], points : 2, levels: [1, 50]},
            {name: "Cave Bat", health: 1, weapons: [{name: "Sharp Fangs", damage: "1d2"}], xp: 5, coins: 5, drops: [], points : 1, levels: [1, 100]},
            {name: "Stone Golem", health: 100, weapons: [{name: "Stone Fist", damage: "1d5"}], xp: 100, coins: 100, drops: [{name: "tiny health potion", type: "consumables", value: 1, chance: 0.1},{name: "stone", type: "ore", value: 50, chance: 0.8}], points : 50, levels: [1, 100]},
            {name: "Mushroom Man", health: 20, weapons: [{name: "Spore Cloud", damage: "1d2"}, {name: "Fungal Punch", damage: "1d3"}], xp: 50, coins: 8, drops: [{name: "tiny health potion", type: "consumables", value: 1, chance: 0.8},{name: "small health potion", type: "consumables", value: 1, chance: 0.2},{name: "medium health potion", type: "consumables", value: 1, chance: 0.1}], points : 5, levels: [1, 100]},
            {name: "Cave Worm", health: 10, weapons: [{name: "Bite", damage: "1d3"}], xp: 30, coins: 30, drops: [], points : 3, levels: [5, 25]},
            {name: "Quartz Elemental", health: 90, weapons: [{name: "Crystal Spike", damage: "1d4"}], xp: 90, coins: 180, drops: [{name: "tiny health potion", type: "consumables", value: 1, chance: 0.1},{name: "rough amethyst", type: "ore", value: 1, chance: 0.1}], points : 36, levels: [50, 125]},
            {name: "Green Slime", health: 20, weapons: [{name: "Acidic Touch", damage: "1d3"}], xp: 30, coins: 30, drops: [{name: "tiny health potion", type: "consumables", value: 1, chance: 0.4}], points : 6, levels: [1, 100]},     
            {name: "Cave Serpent", health: 80, weapons: [{name: "Venomous Bite", damage: "2d3"}], xp: 80, coins: 80, drops: [], points : 48, levels: [25, 150]},
            {name: "Crystal Crab", health: 120, weapons: [{name: "Claw Pinch", damage: "1d4+1"}], xp: 100, coins: 100, drops: [{name: "rough amethyst", type: "ore", value: 1, chance: 0.1}], points : 60, levels: [10, 200]},
            {name: "Iron Golem", health: 200, weapons: [{name: "Iron Fist", damage: "2d5"}], xp: 200, coins: 200, drops: [{name: "iron ore", type: "ore", value: 25, chance: 0.1}], points : 200, levels: [100, 250]},
            {name: "Cave Ogre", health: 200, weapons: [{name: "Great Club", damage: "3d3+1"}], xp: 200, coins: 210, drops: [{name: "small health potion", type: "consumables", value: 1, chance: 0.8},{name: "medium health potion", type: "consumables", value: 1, chance: 0.2},{name: "large health potion", type: "consumables", value: 1, chance: 0.1},{name: "Ogre's Great Club", type: "combat", value: {price: 10, damage:"3d3+1"}, chance:0.05}], points : 200, levels: [100, 200]},
            {name: "Chasm Drake", health: 180, weapons: [{name: "Fiery Breath", damage: "3d4"}, {name: "Claw Swipe", damage: "2d3"}], xp: 210, coins: 210, drops: [], points : 210, levels: [100, 500]},
            {name: "Lava Slime", health: 90, weapons: [{name: "Molten Touch", damage: "1d4+4"}], xp: 120, coins: 120, drops: [{name: "small health potion", type: "consumables", value: 1, chance: 0.5}], points : 72, levels: [100, 175]},
            {name: "Shadow Dweller", health: 110, weapons: [{name: "Shadow Blade", damage: "2d3"}, {name: "Dark Dagger", damage: "1d4"}], xp: 110, coins: 200, drops: [{name: "small health potion", type: "consumables", value: 1, chance: 0.8},{name: "medium health potion", type: "consumables", value: 1, chance: 0.2},{name: "large health potion", type: "consumables", value: 1, chance: 0.1},{name: "Shadow Dweller's Blade", type: "combat", value: {price: 10, damage:"2d3"}, chance:0.04},{name: "Shadow Dweller's Dagger", type: "combat", value: {price: 10, damage:"1d4"}, chance:0.08}], points : 55, levels: [50, 500]},
            {name: "Echo Bat", health: 10, weapons: [{name: "Sonic Screech", damage: "1d4"}], xp: 49, coins: 20, drops: [], points : 4, levels: [100, 200]},
            {name: "W Imp", health: 10, weapons: [{name: "Whine", damage: "1d2"}, {name: "Cower", damage: 1}], xp: 10, coins: 10, drops: [{name: "small health potion", type: "consumables", value: 1, chance: 0.4},{name: "medium health potion", type: "consumables", value: 1, chance: 0.2},{name: "tiny health potion", type: "consumables", value: 1, chance: 0.8}], points : 1, levels: [5, 10]},
            {name: "Skeleton", health: 10, weapons: [{name: "Stare Into The Distance", damage: 0}], xp: 1, coins: 10, drops: [{name: "tiny health potion", type: "consumables", value: 1, chance: 0.5}], points : 1, levels: [1, 10]},
            {name: "Bi-Blanket", health: 10, weapons: [{name: "Confuse", damage: 3}, {name: "Tangle", damage: "1d2"}], xp: 30, coins: 30, drops: [], points : 5, levels: [5, 10]},
            {name: "Two-Headed Rat", health: 10, weapons: [{name: "Bite", damage: "1d2"}, {name: "Double Bite", damage: "2d2"}, {name: "Triple Bite", damage: "3d2"}], xp: 40, coins: 40, drops: [], points : 5, levels: [5, 10]},
            {name: "Miniboss Spicy Espresso Bean", health: 50, weapons: [{name: "Bowel Poison", damage: "6d2"}, {name: "Bean Bag Gun", damage: "5d3"}], xp: 100, coins: 100, drops: [], points : 10, levels: [10, 50]},
            {name: "Miniboss Galgarothnikosh", health: 10, weapons: [{name: "FIRE OF THE OVERLORDS", damage: "1d3"}, {name: "RAIN OF BRIMSTONE", damage: "6d2"}], xp: 100, coins: 200, drops: [{name: "Galgarothnikosh's Megaphone", type: "combat", value: {price: 100, damage:"1d3"}, chance:1}], points : 10, levels: [10, 50]},
            {name: "Miniboss Stone Brute", health: 300, weapons: [{name: "Earthshatter Hammer", damage: "3d6"}, {name: "Rockfall", damage: "4d4"}], xp: 500, coins: 500, drops: [{name: "Stone Brute's Greathammer", type: "combat", value: {price: 1000, damage:"3d6"}, chance:0.05},{name: "stone", type: "ore", value: 100, chance: 0.1}], points : 500, levels: [100, 300]},
            {name: "Miniboss Crystal Warlord", health: 350, weapons: [{name: "Gemblade", damage: "4d4+3"}, {name: "Crystalline Shield Bash", damage: "3d6"}], xp: 500, coins: 500, drops: [{name: "Crystal Warlord's Gemblade", type: "combat", value: {price: 1000, damage:"4d4+3"}, chance:0.025},{name: "rough amethyst", type: "ore", value: 10, chance: 0.1}], points : 650, levels: [150, 400]},
            {name: "Miniboss Flame Brute", health: 370, weapons: [{name: "Inferno Axe", damage: "3d5"}, {name: "Fire Punch", damage: "2d6"}], xp: 500, coins: 650, drops: [{name: "Flame Brute's Inferno Axe", type: "combat", value: {price: 1000, damage:"3d5"}, chance:0.01}], points : 480, levels: [100, 400]},
            {name: "Miniboss Shadow Dweller Assassin", health: 330, weapons: [{name: "Dagger of Darkness", damage: "3d4+1"}, {name: "Silent Strike", damage: "2d5"}], xp: 500, coins: 550, drops: [{name: "Shadow Dweller's Assassin Dagger", type: "combat", value: {price: 1000, damage:"3d4+1"}, chance:0.01}], points :400, levels: [50, 500]},
            {name: "Miniboss Mine Guardian", health: 360, weapons: [{name: "Granite Smash", damage: "3d6"}, {name: "Stone Shield Bash", damage: "2d4+2"}], xp: 500, coins: 600, drops: [{name: "stone", type: "ore", value: 100, chance: 0.1}], points : 650, levels: [250, 500]},
            {name: "Boss Lava Serpent", health: 620, weapons: [{name: "Volcanic Fang", damage: "5d5"}, {name: "Lava Surge", damage: "4d6"}], xp: 1200, coins: 1100, drops: [], points : 1050, levels: [400, 500]},
            {name: "Boss Shadow Dweller Overlord", health: 580, weapons: [{name: "Eclipse Blade", damage: "4d6+3"}, {name: "Dark Nova", damage: "3d5"}], xp: 1900, coins: 950, drops: [{name: "Shadow Overlord's Blade", type: "combat", value: {price: 6000, damage:"4d6+3"}, chance:0.01}], points : 1000, levels: [50, 500]},
            {name: "Boss Abyssal Titan", health: 600, weapons: [{name: "Abyssal Glaive", damage: "5d4+4"}, {name: "Void Slam", damage: "4d4+2"}], xp: 2000, coins: 1000, drops: [{name: "Abyssal Titan's Glaive", type: "combat", value: {price: 6500, damage:"5d4+4"}, chance:0.01}], points : 1050, levels: [400, 500]},
            {name: "Boss Stone Behemoth", health: 800, weapons: [{name: "Apocalyptic Maul", damage: "6d6"}, {name: "Tectonic Blast", damage: "5d6"}], xp: 2500, coins: 2000, drops: [{name: "Behemoth's Maul", type: "combat", value: {price: 6000, damage:"6d6"}, chance:0.01},{name: "stone", type: "ore", value: 200, chance: 0.1}], points : 1500, levels: [450, 500]},
            {name: "Boss Void Tyrant", health: 750, weapons: [{name: "Voidrender Sword", damage: "5d6+4"}, {name: "Cosmic Annihilation", damage: "4d6+3"}], xp: 2480, coins: 1800, drops: [{name: "Void Sword", type: "combat", value: {price: 6000, damage:"5d6+4"}, chance:0.01}], points : 2500, levels: [450, 500]},
            {name: "Boss Infernal Dragonlord", health: 1000, weapons: [{name: "Inferno Breath", damage: "6d5"}, {name: "Dragonclaw Swipe", damage: "5d4+2"}], xp: 2490, coins: 1900, drops: [{name: "Dragon's Claw", type: "combat", value: {price: 7500, damage:"5d4"}, chance:0.02}], points : 3000, levels: [450, 500]},
            {name: "Boss Eternal Guardian", health: 1400, weapons: [{name: "Celestial Spear", damage: "5d6+3"}, {name: "Stellar Barrage", damage: "4d5+2"}], xp: 2460, coins: 1850, drops: [{name: "Guardian's Celestial Spear", type: "combat", value: {price: 8000, damage:"5d6+3"}, chance:0.01}], points : 4500, levels: [450, 500]},
            {name: "Boss Abyssal Overlord", health: 1800, weapons: [{name: "Abyssal Greatsword", damage: "6d10"}, {name: "Oblivion Wave", damage: "2d20+10"}], xp: 5000, coins: 5200, drops: [{name: "Abyssal Lord's Greatsword", type: "combat", value: {price: 10000, damage:"6d10"}, chance:0.005}], points : 10000, levels: [450, 500]}
